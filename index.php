 ...
 *
 * The site root sends visitors straight to the guest reservation form rather than the backend
 * login, so the login page is not the first thing a random visitor (or bot) sees.
 */
session_start();
