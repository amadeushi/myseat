...
<form method="post" action="?p=6" id="edit_outlet_form">
	...
	&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_1)); ?>
	<p>
	...
	&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_2)); ?>
	<p>
	...
	&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_4)); ?>	
	<p>	 	 	 	 	 	 	
	...
	&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_5)); ?>	
	<p>	 	 	 	 	 	 	
	...
	&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_6)); ?>	
	<p>	 	 	 	 	 	 			
			<?php getDurationList($general['timeintervall'],'avg_duration',$row->avg_duration);?>
	</p>
	<label><?php echo _password;?></label>
	&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_7)); ?>	
	<p>	 	 	 	 	 	 	
	...
	&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_8)); ?>
	<p>		
...
<div class="twocolumn_wrapper right">
	<div class="twocolumn" >
		<div class="content form-height">
			...
			&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_9)); ?>
			<p>		
				<?php
			...
			&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_13)); ?>
			<p>	
			...
			&nbsp;<?php echo uiIcon('info', array('class' => 'tipsyold', 'title' => MAN_14)); ?>
			<p>	
				<table class='opentime-table'>
 	 	 	 	 <?php
					$day = strtotime("next Monday");
